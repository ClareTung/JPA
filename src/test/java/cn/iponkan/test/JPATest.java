...
import cn.ipokan.entity.Category;
import cn.ipokan.entity.Customer;
import cn.ipokan.entity.Department;
import cn.ipokan.entity.Item;
import cn.ipokan.entity.Manager;
import cn.ipokan.entity.Order;

/**
* @author 作者 :董唐强
* @version 创建时间：2018年8月25日 下午9:49:34
* 说明：
*/
public class JPATest {
	...
	public void testExecuteUpdate(){
		...
		Query query = entityManager.createQuery(jpql).setParameter(1, "MMM").setParameter(2, 5);
	...
	public void testSubQuery(){
		//查询所有 Customer 的 lastName 为 GG 的 Order
		String jpql = "SELECT o FROM Order o "
				+ "WHERE o.customer = (SELECT c FROM Customer c WHERE c.lastName = ?)";
		
		Query query = entityManager.createQuery(jpql).setParameter(1, "GG");
	...
	public void testLeftOuterJoinFetch(){
		...
		Customer customer = 
				(Customer) entityManager.createQuery(jpql).setParameter(1, 4).getSingleResult();
...
//		customer.setId(2);// 移除不掉
	...
	public void testPersistence(){
		...
		//Caused by: org.hibernate.PersistentObjectException: detached entity passed to persist: cn.ipokan.entity.Customer
//		customer.setId(100);
